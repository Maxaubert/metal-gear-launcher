...
- Install locally after merge: `dist\MetalGearLauncher-Setup-x64-<version>.exe`   Confirm version: hub footer (shown on an update prompt) or Windows Apps & features
