...
/** Atlas regions share the images' bottom-right fit, including their visible ink origin. */
export default function HeaderArtwork({ artwork, className, label = "" }: {
  ...
  return <svg className={className} viewBox={`${crop.x} ${crop.y} ${crop.width} ${crop.height}`} preserveAspectRatio="xMaxYMax meet"
